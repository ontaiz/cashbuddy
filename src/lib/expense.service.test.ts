...
describe('ExpenseService', () => {
  ...
  describe('getPaginatedExpenses', () => {
    ...
    it('should handle errors when fetching expenses', async () => {
      ...
      await expect(
        expenseService.getPaginatedExpenses(mockSupabaseClient as any, 'user-id', options)
  ...
  describe('createExpense', () => {
    ...
    it('should handle creation errors', async () => {
      ...
      await expect(
        expenseService.createExpense(mockSupabaseClient as any, 'user-id', newExpense)

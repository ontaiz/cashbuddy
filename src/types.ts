 ...
 */
export type CreateExpenseCommand = Pick<TablesInsert<"expenses">, "amount" | "name" | "date" | "description">;
 ...
 */
export type UpdateExpenseCommand = Omit<TablesUpdate<"expenses">, "id" | "user_id" | "created_at">;

/**
 * Represents a top expense item in the dashboard summary.
 * This is a subset of the full ExpenseDto.
 */
export type TopExpenseDto = Pick<Tables<"expenses">, "id" | "name" | "amount" | "date">;
